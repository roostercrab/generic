defmodule Generic.Accounts.Users do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Generic.Repo)
  ...
  Returns the given users if valid,

  If there is no users or the users doesn't have a password, we call
  `Bcrypt.no_user_verify/0` to avoid timing attacks.
  """
  def valid_password?(%Generic.Accounts.Users{hashed_password: hashed_password}, password)
